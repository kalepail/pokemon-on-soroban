...
export const EXTENDED_INPUT_BYTES = 12;
...
export function readInputPacket(message: ArrayBuffer): InputPacket | null {
  ...
  return {
    ...
    aimAngle: message.byteLength >= EXTENDED_INPUT_BYTES ? view.getUint16(8, true) % ANGLE_STEPS : 0,
    throttle: message.byteLength >= EXTENDED_INPUT_BYTES ? Math.min(255, view.getUint8(10)) : 0,
  };
}
